...
4. Find "Custom Plugin Repositories" section, agree with listed terms if needed and paste the following link into text input field: `https://github.com/noneed-meaning/LifestreamCN/raw/main/pluginmaster.json`
5. Click "Save" button.
